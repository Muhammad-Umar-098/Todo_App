...
import 'package:taskapp/add_task_view.dart';
import 'package:taskapp/task_view.dart';
...
class _HomeViewState extends State<HomeView> {
  List<Map<String, String>> tasks = [
    {
      "title": "Take addmissin",
      "date": "30 July 2024",
      "status": "To do",
    },
    {"title": "Classes start", "date": "8 August 2024", "status": "Done"}
  ];
                        ...
                        IconButton(
                            onPressed: () {
                              Navigator.of(context).push(MaterialPageRoute(
                                builder: (context) =>
                                    AddTaskView(onAddTaskView: _addTask),
                              ));
                            },
                            icon: const Icon(
                              Icons.circle,
